...
namespace TheOtherRoles {
    ...
    public static class Helpers
    {
        ...
        public static bool hasFakeTasks(this PlayerControl player) {
            return (player == Jester.jester || player == Befriender.befriender || player == Haunter.haunter || player == Jackal.jackal || player == Sidekick.sidekick || player == Arsonist.arsonist || player == Vulture.vulture || Jackal.formerJackals.Any(x => x == player));
        }
        ...
        public static bool roleCanUseVents(this PlayerControl player) {
            ...
            if (Engineer.engineer != null && Engineer.engineer == player)
                ...
                roleCouldUse = false;
                else if (Sniper.sniper && Sniper.sniper == player && !Sniper.canVent) 
                roleCouldUse = false;
                else
                    roleCouldUse = true;
            }
        ...
        public static bool hasImpVision(GameData.PlayerInfo player) {
            return player.Role.IsImpostor
                ...
                || (Ghost.ghost != null && Ghost.hasImpostorVision && Ghost.ghost.PlayerId == player.PlayerId);
        }
